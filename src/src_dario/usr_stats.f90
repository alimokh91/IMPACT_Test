   ...
   do while (pw.le.3) 
     ...
     DO k = S3p, N3p, strd
        DO j = S2p, N2p, strd
           DO i = S1p, N1p, strd
              if (x1p(i).ge. 9.0.and.x1p(i).le.13.0 .and. x2p(j).ge.0.5.and.x2p(j).le.1.5 ) then
     ...
     DO k = S3p, N3p, strd
        DO j = S2p, N2p, strd
           DO i = S1p, N1p, strd
              if (x1p(i).ge.11.0.and.x1p(i).le.13.0 .and. x2p(j).ge.0.5.and.x2p(j).le.1.5 ) then
              stats_group%n_data = stats_group%n_data + 1
              DO ii = i, i+strd-1
                 DO jj = j, j+strd-1
                    DO kk = k, k+strd-1
     ...
     DO k = S3p, N3p, strd
        DO j = S2p, N2p, strd
           DO i = S1p, N1p, strd
              if (x1p(i).ge.12.0.and.x1p(i).le.13.0 .and. x2p(j).ge.0.5.and.x2p(j).le.1.5 ) then
              stats_group%n_data = stats_group%n_data + 1
              DO ii = i, i+strd-1
                 DO jj = j, j+strd-1
                    DO kk = k, k+strd-1
     ...
     DO k = S3p, N3p, strd
        DO j = S2p, N2p, strd
           DO i = S1p, N1p, strd
              if (x1p(i).ge. 9.0.and.x1p(i).le.13.0 .and. x2p(j).ge.0.0.and.x2p(j).le.2.0 ) then
              stats_group%n_data = stats_group%n_data + 1
              DO ii = i, i+strd-1
                 DO jj = j, j+strd-1
                    DO kk = k, k+strd-1
     ...
     DO k = S3p, N3p, strd
        DO j = S2p, N2p, strd
           DO i = S1p, N1p, strd
              if (x1p(i).ge.11.0.and.x1p(i).le.13.0 .and. x2p(j).ge.0.0.and.x2p(j).le.2.0 ) then
              stats_group%n_data = stats_group%n_data + 1
              DO ii = i, i+strd-1
                 DO jj = j, j+strd-1
                    DO kk = k, k+strd-1
   ...
   IF (rank == 0 .AND. dtime_out_scal /= 0.) THEN
     ...
     DO id = 1, num_windows
        ...
        OPEN(33+id,FILE='tke_window_'//id_char//'_'//restart_char//'.txt',STATUS='UNKNOWN')
     END DO
   END IF
