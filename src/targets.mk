...
local:	LIBS = -L/usr/lib/x86_64-linux-gnu -L$(HPC_PREDICT_IO_DIR)/lib -lm -ldl -llapack -L/opt/openmpi_gcc_native_shared/lib -lmpi_mpifh -lmpi_usempif08 -L/opt/hdf5_gcc_native_shared/lib -lhdf5_fortran -lhdf5hl_fortran -lhdf5_hl -lhdf5 -lz -lm -ldl -lstdc++
