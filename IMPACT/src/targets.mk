...
local:	COMP = mpifort
local:	INCL = -I/usr/include -I/opt/hdf5_gcc_native_shared/include -I/opt/openmpi_gcc_native_shared/include -I$(HPC_PREDICT_IO_DIR)/include
local:	LIBS = -L/usr/lib/x86_64-linux-gnu -L$(HPC_PREDICT_IO_DIR)/lib -lm -ldl -llapack -L/opt/openmpi_gcc_native_shared/lib -lmpi_mpifh -lmpi_usempif08 -L/opt/hdf5_gcc_native_shared/lib -lhdf5_fortran -lhdf5hl_fortran -lhdf5_hl -lhdf5 -lz -lm -ldl
...
portable: INCL = -I/usr/include -I$(HDF5_DIR)/include -I$(HPC_PREDICT_IO_DIR)/include
portable: LIBS = -L/usr/lib -lm -ldl -lz -lopenblas -lscalapack -L$(HPC_PREDICT_IO_DIR)/lib -L$(HDF5_DIR)/lib -lhpc-predict-io -lhdf5_fortran -lhdf5_hl -lhdf5
portable:       OPT1 = -ffree-form -ffree-line-length-none -cpp -fdefault-real-8 -O2 #-g -fbounds-check -fbacktrace
#-O3 -ffast-math -funroll-all-loops -fpeel-loops -ftracer -funswitch-loops \
