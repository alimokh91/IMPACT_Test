...
mpifort mr_io_test_reader_hpc_predict.o mr_io.o mr_io_parallel.o  mr_io_protocol.o mr_io_test_arg_parser.o -o mr_io_test_reader_hpc_predict -L${HDF5_DIR}/lib -Wl,-rpath=${HDF5_DIR}/lib -lhdf5_fortran
mpifort mr_io_test_reader_segmented_hpc_predict.o mr_io.o mr_io_parallel.o  mr_io_protocol.o mr_io_test_arg_parser.o -o mr_io_test_reader_segmented_hpc_predict -L${HDF5_DIR}/lib -Wl,-rpath=${HDF5_DIR}/lib -lhdf5_fortran
...
mpifort mr_io_test_parallel_reader_hpc_predict.o mr_io.o mr_io_parallel.o mr_io_parallel_spacetime.o  mr_io_protocol.o mr_io_test_arg_parser.o -o mr_io_test_parallel_reader_hpc_predict -L${HDF5_DIR}/lib -Wl,-rpath=${HDF5_DIR}/lib -lhdf5_fortran
mpifort mr_io_test_parallel_reader_segmented_hpc_predict.o mr_io.o mr_io_parallel.o mr_io_parallel_spacetime.o  mr_io_protocol.o mr_io_test_arg_parser.o -o mr_io_test_parallel_reader_segmented_hpc_predict -L${HDF5_DIR}/lib -Wl,-rpath=${HDF5_DIR}/lib -lhdf5_fortran
mpifort mr_io_test_parallel_reader_hpc_predict_padded.o mr_io.o mr_io_parallel.o mr_io_parallel_spacetime.o  mr_io_protocol.o mr_io_test_arg_parser.o -o mr_io_test_parallel_reader_hpc_predict_padded -L${HDF5_DIR}/lib -Wl,-rpath=${HDF5_DIR}/lib -lhdf5_fortran
...
mpifort mr_io_test_reader_writer_hpc_predict.o mr_io.o mr_io_parallel.o  mr_io_protocol.o mr_io_test_arg_parser.o -o mr_io_test_reader_writer_hpc_predict -L${HDF5_DIR}/lib -Wl,-rpath=${HDF5_DIR}/lib -lhdf5_fortran
mpifort mr_io_test_reader_writer_segmented_hpc_predict.o mr_io.o mr_io_parallel.o  mr_io_protocol.o mr_io_test_arg_parser.o -o mr_io_test_reader_writer_segmented_hpc_predict -L${HDF5_DIR}/lib -Wl,-rpath=${HDF5_DIR}/lib -lhdf5_fortran
...
mpifort mr_io_test_parallel_reader_writer_hpc_predict.o mr_io.o mr_io_parallel.o  mr_io_parallel_spacetime.o  mr_io_protocol.o mr_io_test_arg_parser.o -o mr_io_test_parallel_reader_writer_hpc_predict -L${HDF5_DIR}/lib -Wl,-rpath=${HDF5_DIR}/lib -lhdf5_fortran
mpifort mr_io_test_parallel_reader_writer_segmented_hpc_predict.o mr_io.o mr_io_parallel.o  mr_io_parallel_spacetime.o  mr_io_protocol.o mr_io_test_arg_parser.o -o mr_io_test_parallel_reader_writer_segmented_hpc_predict -L${HDF5_DIR}/lib -Wl,-rpath=${HDF5_DIR}/lib -lhdf5_fortran
mpifort mr_io_test_parallel_reader_writer_hpc_predict_padded.o mr_io.o mr_io_parallel.o  mr_io_parallel_spacetime.o  mr_io_protocol.o mr_io_test_arg_parser.o -o mr_io_test_parallel_reader_writer_hpc_predict_padded -L${HDF5_DIR}/lib -Wl,-rpath=${HDF5_DIR}/lib -lhdf5_fortran
