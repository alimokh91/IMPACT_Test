program mr_io_test_parallel_reader_writer_flow
    ...
    INTEGER err
!    character(len=100) :: in_path = "mr_io_test_parallel_flow_in.h5"
!    character(len=100) :: out_path = "mr_io_test_parallel_flow_out.h5"
...
!    ! End of debugging
    ...
    call mr_io_write_parallel_flow(MPI_COMM_WORLD, MPI_INFO_NULL, out_path, mri_dest)

    call MPI_Finalize(err)

end program mr_io_test_parallel_reader_writer_flow
