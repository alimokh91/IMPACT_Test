program mr_io_test_parallel_reader_segmented_flow_padded
...
!    call flush()
    ...
    print *, lbound(mri_dest%segmentation_prob%array)
    print *, ubound(mri_dest%segmentation_prob%array)
...
end program mr_io_test_parallel_reader_segmented_flow_padded
