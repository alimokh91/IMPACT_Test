...
mpifort -g -c -fbacktrace mr_io_test_arg_parser.f90 -I.. -I${HDF5_DIR}/include
mpifort -g -c -cpp -fbacktrace mr_io_test_impact_input.f90 -I.. -I${IMPACT_DIR} -I${MPI_DIR} -I${HDF5_DIR}/include
mpifort -g -c -cpp -fbacktrace  *.f90 -I.. -I${IMPACT_DIR}  -I${MPI_DIR}  -I${HDF5_DIR}/include
