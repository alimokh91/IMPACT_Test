...
mpifort -c mr_io_protocol.f90 -I${HDF5_DIR}/include
mpifort -c -cpp mr_io.f90  -I${MPI_DIR} -I${HDF5_DIR}/include
mpifort -c -cpp mr_io_parallel.f90  -I${MPI_DIR} -I${HDF5_DIR}/include
mpifort -c -cpp mr_io_parallel_spacetime.f90  -I${MPI_DIR} -I${HDF5_DIR}/include
mpifort -c -cpp  *.f90 -I${IMPACT_DIR}  -I${MPI_DIR}  -I${HDF5_DIR}/include
cd test
./build.sh
cd ..
