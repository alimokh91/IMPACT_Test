...
class TestSpatialMRIBidirectional(unittest.TestCase):
    ...
    def setUp(self):
        ...
        #scalar_feature = np.reshape(np.array((9*[0]) + (9*[1])), (2,3,3))
...
class TestSegmentedFlowMRIPaddedBidirectional(unittest.TestCase): # FIXME: coordinates test...
    ...
    # Filenames
    filename_prefix = os.environ['FORTRAN_TEST_BINARY_PATH'] + "mr_io_test_parallel_reader_writer_segmented_flow_padded"
...
class TestSegmentedFlowMRIPaddedToSpaceTimeBidirectional(unittest.TestCase): # FIXME: coordinates test...
    ...
    # Filenames
    filename_prefix = os.environ['FORTRAN_TEST_BINARY_PATH'] + "mr_io_test_parallel_reader_writer_segmented_flow_padded_to_space_time"
