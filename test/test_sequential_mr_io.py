...
class TestHPCPredictMRI(unittest.TestCase):
    ...
    def test_communicator(self):
        ...
        fort_group_name, fort_x_dim_str, fort_x_coord_str,fort_y_dim_str, fort_y_coord_str, fort_z_dim_str, fort_z_coord_str, fort_t_dim_str, fort_t_coord_str, fort_dims_str, fort_array_str, fort_dims_str2, fort_array_str2, _ = fort_stdout.split('\n')
