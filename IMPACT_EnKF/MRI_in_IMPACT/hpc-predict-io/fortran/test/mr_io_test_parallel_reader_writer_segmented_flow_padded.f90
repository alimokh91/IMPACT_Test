program mr_io_test_parallel_reader_writer_segmented_flow_padded
...
!    call flush()
    ...
    call mr_io_write_parallel_segmentedflow(MPI_COMM_WORLD, MPI_INFO_NULL, out_path, mri_dest_padded%mri)

    call MPI_Finalize(err)
        
end program mr_io_test_parallel_reader_writer_segmented_flow_padded
